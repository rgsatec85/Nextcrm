    ...
    <div className="space-y-8">
      <section className="flex items-start justify-between">
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          {score && (
            <span
              className={`rounded-full px-3 py-1 text-xs font-medium ${SCORE_BADGE[score.classification]}`}
              title="Score Financeiro — heurística de pontualidade/inadimplência (Fase 2), não é o Score IA da Fase 4"
            >
